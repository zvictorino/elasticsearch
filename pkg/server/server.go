...
// ElasticsearchServer contains state for a Kubernetes cluster master/api server.
type ElasticsearchServer struct {
	GenericAPIServer *genericapiserver.GenericAPIServer
	Operator         *controller.Controller
}

func (op *ElasticsearchServer) Run(stopCh <-chan struct{}) error {
...
func (c *ElasticsearchServerConfig) Complete() CompletedConfig {
...
// New returns a new instance of ElasticsearchServer from the given config.
func (c completedConfig) New() (*ElasticsearchServer, error) {
