...
import (
	...
	"kubedb.dev/elasticsearch/pkg/server"
)
...
func (o ElasticsearchServerOptions) Config() (*server.ElasticsearchServerConfig, error) {
	...
	config := &server.ElasticsearchServerConfig{
