...
func NewCmdRun() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if err := docker.CheckDockerImageVersion(controller.ImageElasticDump, elasticDumpTag); err != nil {
			...
			w := controller.New(client, extClient, promClient, operatorTag, elasticDumpTag, governingService, address)
